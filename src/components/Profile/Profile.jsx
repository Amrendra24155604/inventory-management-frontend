...
function CompleteProfile() {
  ...
  return (
    <main className="min-h-screen w-full bg-transparent dark:bg-transparent flex items-center justify-center px-4 py-8 sm:px-6 lg:px-8">
      <div className="relative w-full max-w-3xl">
        ...
        <div className="relative backdrop-blur-xl bg-white/70 dark:bg-slate-900/30 rounded-3xl border border-slate-200/50 dark:border-slate-800/40 shadow-xl px-4 py-6 sm:px-6 sm:py-8">
          {isEditing ? (
            <>
