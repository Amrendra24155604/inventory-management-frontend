...
function Header({ user }) {
  ...
  return (
    <>
      <header className="fixed top-0 left-0 right-0 z-50 border-b border-slate-200 bg-slate-50/90 backdrop-blur-xl shadow-sm dark:border-slate-800 dark:bg-slate-900/80">
